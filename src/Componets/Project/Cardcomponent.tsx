...
function Cardcomponent({ imgs, title, github, live }: CardcomponentProps) {
  return (
    <div className="border-2 rounded-xl bg-gradient-to-tl from-violet-600 to-violet-200 p-3">
      ...
      <div className="flex space-x-6 justify-center relative z-10 pointer-events-auto my-4">
        {github && (
          <div>
            <a href={github} target="_blank" rel="noopener noreferrer" className="text-gray-200 text-md  hover:underline  ">
              Github
            </a>
          </div>
        )}
        ...
        {live && (
          <div>
            <a href={live} target="_blank" rel="noopener noreferrer" className="text-gray-200 text-md hover:underline">
              Live
            </a>
          </div>
        )}
